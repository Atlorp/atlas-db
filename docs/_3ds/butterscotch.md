...
color: '#9c7447'
color_bg: '#805f3a'
created: '2026-03-24T12:47:07Z'
description: '🥧 An open source re-implementation of GameMaker: Studio''s runner (YoYo
...
update_notes: '<h2 dir="auto">Changelog:</h2>
  ...
  <li>Download new .cia and .exe</li>

  <li>Delete old .cia file (Without it nothing be fixed!)</li>

  <li>Preprocess your games with new preprocessor tool</li>
