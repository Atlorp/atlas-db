...
prerelease:
  download_page: https://github.com/atticpad/atticpad/releases/tag/v0.6.0-rc5
  downloads:
    atticpad-3ds.3dsx:
      size: 366888
      size_str: 358 KiB
      url: https://github.com/atticpad/atticpad/releases/download/v0.6.0-rc5/atticpad-3ds.3dsx
    atticpad-3ds.cia:
      size: 420800
      size_str: 410 KiB
      url: https://github.com/atticpad/atticpad/releases/download/v0.6.0-rc5/atticpad-3ds.cia
  qr:
  ...
  update_notes: '<h3 dir="auto">Added</h3>
    ...
    It needs access to <code class="notranslate">/dev/uinput</code> — <a href="https://github.com/atticpad/atticpad/blob/v0.6.0-rc5/docs/INSTALL.md">INSTALL.md</a>
    has the<br>
    ...
    <a target="_blank" rel="noopener noreferrer nofollow" href="https://raw.githubusercontent.com/atticpad/atticpad/v0.6.0-rc5/docs/img/fbi-install-qr.png"><img
    src="https://raw.githubusercontent.com/atticpad/atticpad/v0.6.0-rc5/docs/img/fbi-install-qr.png"
    ...
    join an open or WEP network; <a href="https://github.com/atticpad/atticpad/blob/v0.6.0-rc5/docs/SETUP-DS.md">SETUP-DS.md</a>
    shows how to<br>
  ...
  update_notes_md: "\n### Added\n\n- **Keyboard, mouse and media remote control**,\
    ...
    \ no longer looks like a real address.\n\n### Fixed\n\n- **A sticky Shift on the\
    \ 3DS typed a lowercase letter.** The server applied\n  a report's keys in usage\
    \ order, so a letter arriving in the same report as\n  Shift was pressed before\
    \ it. Modifiers now go first, as a host treats a\n  real HID keyboard report.\n\
    ...
    \  is removed first now.\n- **The PSP rejoins the network after a suspend.** A\
    \ power callback re-runs\n  the network bring-up on resume.\n\n\n---\n\n## Install\n\
    \n**Server** — on the PC that needs a controller. Pick one:\n\n- **Windows:**\
    \ download `atticpad-server-windows-x86_64.exe` and run it. It needs\n  the ViGEmBus\
    \ driver, which is easiest to install with winget:\n\n  ```\n  winget install\
    ...
    \ it, and run it.\n  It needs access to `/dev/uinput` — [INSTALL.md](https://github.com/atticpad/atticpad/blob/v0.6.0-rc5/docs/INSTALL.md)\
    ...
    \  <img src=\"https://raw.githubusercontent.com/atticpad/atticpad/v0.6.0-rc5/docs/img/fbi-install-qr.png\"\
    ...
    \ WEP network; [SETUP-DS.md](https://github.com/atticpad/atticpad/blob/v0.6.0-rc5/docs/SETUP-DS.md)\
  ...
  updated: '2026-09-15T12:03:46Z'
  version: v0.6.0-rc5
  version_title: AtticPad v0.6.0-rc5
qr:
